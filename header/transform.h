...
void Near_attribution(const Mat &gray, Mat &vote, Mat & big,Mat & small, int x, int y, Mat &newgray, Mat &newvote,Mat &newbig ,Mat &newsmall , Mat &newdiff);
...
// Mat L0g(Mat &gray, Mat &tag,long long sum[],long nums[]);
 ...
 Mat smooth_gray(Mat &obj, long long sum[], long nums[],long gray[]) ;
